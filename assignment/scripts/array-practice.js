...
let foodArray = ['pizza', 'sloppy joes', 'bratwurst', 'fried fish', 'garlic bread']
...
console.log('Amount of favorite foods:', foodArray.length);
...
console.log('Added a new food', foodArray);
...
console.log('The remaining foods are:', foodArray);
...
foodArray.unshift('waffles')
console.log(`Added food to the beginning: ${foodArray}`);
console.log('Added food to the beginning:', foodArray);
...
console.log('The remaining foods are now', foodArray);